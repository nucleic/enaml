...
class TemplateInstance(Atom):
    ...
    Instances of this class are created by instance of Template. They
    should not typically be created directly by user code.

    """
    #: The template node generated by the specialization.
    _template_node = Typed(TemplateNode)

    #: The local scope generated by the specialization.
    _template_scope = Typed(sortedmap, ())
    ...
    def __call__(self, parent=None, **kwargs):
        ...
        **kwargs
        ...
        # XXX fixme!
        res = []
        for child in self._template_node.children:
    ...
    def __getattr__(self, name):
        ...
        """
        try:
            return self._template_scope[name]
        except KeyError:
...
def _make_scope(scope_tuple):
    """ Create a sortedmap from a scope tuple.

    This function is an implementation detail. It should not be called
    by user code.
...
class Template(Atom):
    ...
    def __call__(self, *args):
        ...
        *args
        ...
        if spec is not None:
            scope_tuple, node = spec.func(*args)
            inst = TemplateInstance()
            inst._template_node = node
            inst._template_scope = _make_scope(scope_tuple)
