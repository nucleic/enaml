...
class CompilerNode(Atom):
    ...
    def __call__(self, parent):
        ...
        ----------
        parent : Object
            The parent object for the portion of the hierarchy.
...
class EnamlDefNode(DeclarativeNode):
    ...
    def __call__(self, parent=None, **kwargs):
        ...
        **kwargs
        ...
        -------
        result : Declarative
            The declarative instance hierarchy.
...
class TemplateNode(Atom):
    ...
    A template node is an abstract representation of the tree described
