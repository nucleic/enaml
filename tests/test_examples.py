...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "applib/live_editor.enaml",
            None,
            marks=pytest.mark.skipif(
                not SCINTILLA_AVAILABLE, reason="Requires scintilla"
            ),
        ),
        ...
        pytest.param(
            "layout/advanced/button_ring.enaml",
            None,
            marks=pytest.mark.skipif(
                not (NUMPY_AVAILABLE),
        ...
        ("layout/advanced/override_layout_constraints.enaml", None),
        ...
        pytest.param(
            "widgets/ipython_console.enaml",
            None,
            marks=pytest.mark.skipif(
                not IPY_AVAILABLE, reason=("Requires IPython and its " "qt console.")
            ),
        ),
        ...
        pytest.param(
            "widgets/mpl_canvas.enaml",
            None,
            marks=pytest.mark.skipif(
                not MATPLOTLIB_AVAILABLE, reason="Requires matplotlib"
            ),
        ),
        ("widgets/notebook.enaml", None),
        ("widgets/popup_menu.enaml", None),
        ("widgets/popup_view.enaml", handle_popup_view_example),
        ...
        pytest.param(
            "widgets/vtk_canvas.enaml",
            None,
            marks=pytest.mark.skipif(not VTK_AVAILABLE, reason="Requires vtk"),
        ),
        pytest.param(
