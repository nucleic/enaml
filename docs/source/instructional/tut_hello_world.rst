...
Finally, we create a QtApplication object, which is necessary to configure the 
backend toolkit. After we instantiate the Main widget, show() it and then start
