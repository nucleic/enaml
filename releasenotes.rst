...
- support for Python 3.12 PR #535
  ...
  is now supported.
- fix a bug in Enaml parser that was not showing proper location of syntax and
  indentation errors in tracebacks when the error was in an Enaml file. PR #530
